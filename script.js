...
ScrollReveal().reveal('#home .right, #services .content img, #advogados .advogado.one, #contato header, #blog h2, .buttonDesktop', { distance: '200px', origin: 'bottom', opacity: 0, duration: 700, easing: 'ease-in-out'});
